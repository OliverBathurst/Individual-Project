        ...
        if (ActivityCompat.checkSelfPermission(c, android.Manifest.permission.READ_CALL_LOG) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (calllog != null) {
                while (calllog.moveToNext()) {
                    ...
                    content.append(c.getString(R.string.num)).append(" ").append(calllog.getString(calllog.getColumnIndex(CallLog.Calls.NUMBER)))
                            .append("\n").append(c.getString(R.string.call_date)).append(" ").append(calllog.getString(calllog.getColumnIndex(CallLog.Calls.DATE)))
                            .append("\n").append(c.getString(R.string.call_time)).append(" ").append(new Date((long) calllog.getColumnIndex(CallLog.Calls.DATE)))
                            .append("\n").append(c.getString(R.string.call_duration)).append(" ").append(calllog.getString(calllog.getColumnIndex(CallLog.Calls.DURATION)))
                            .append("\n").append(c.getString(R.string.call_type)).append(" ").append(type).append("\n");
                }
            }
            if (calllog != null) {
                calllog.close();
